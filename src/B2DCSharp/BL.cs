...
internal static partial class Lib
{
	...
	[LibraryImport(dllPath, EntryPoint = "bl_image_init")]
	internal static partial ResultCode bl_image_init(ref nint handle);
	...
	internal static partial ResultCode bl_context_init_as(ref nint contexhandle, ref nint image_handle, nint nullptr);
	...
	internal static partial ResultCode bl_context_fill_geometry(ref nint context_handle, GeometryType type, ref RoundRect rect);

	[LibraryImport(dllPath, EntryPoint = "bl_gradient_init_as")]
	internal static partial ResultCode bl_gradient_init_as(ref nint self, GradientType type, ref LinearGradientValues values, ExtendMode mode, nint stops_handle, nuint n, nint transform_handle);
	...
	internal static partial ResultCode bl_context_end(nint context_handle);

	[LibraryImport(dllPath, EntryPoint = "bl_image_write_to_file", StringMarshalling =StringMarshalling.Utf8)]
	internal static partial ResultCode bl_image_write_to_file(nint image_handle, string path, nint codec_handle);
